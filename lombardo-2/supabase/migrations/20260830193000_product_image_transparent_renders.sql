-- Non-destructive Product Image System V1 output. The approved source master is
-- retained while a transparent, uniformly framed render becomes the primary.
...
begin
  if p_storage_path !~ '^[0-9a-f-]{36}/renders/product-image-system-v1/[0-9a-f-]{36}\.webp$'
    ...
    or p_background_confidence not in ('high', 'medium')

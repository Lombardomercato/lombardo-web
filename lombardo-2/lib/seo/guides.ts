...
const EDITORIAL_GUIDES: readonly GuideDefinition[] = [
  {
    ...
    catalog: { mode: "category", categorySlug: "vinos", limit: 3, heading: "3 botellas que elegiríamos", description: "Tres puntos de partida para mesas distintas, con precio y disponibilidad actualizados.", allHref: "/categorias/vinos", allLabel: "Ver todos los vinos" },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Los diez productos de abajo se actualizan al abrir la página. El tope se aplica al precio que ves y sólo entran productos disponibles para pedir. Por eso esta nota puede seguir siendo útil después de su publicación sin reescribir el artículo cada vez que una lista cambia.",
          "Si encontrás una botella que te interesa, abrí el producto y sumala desde acá. El precio del carrito vuelve a validarse con el catálogo antes de la compra.",
        ],
      },
    ],
  ...
  },
  {
    ...
    catalog: { mode: "search", categorySlug: "vinos", search: "malbec", limit: 7, heading: "7 Malbec para probar el mapa", description: "Botellas disponibles ahora para probar diferencias reales de productor y estilo.", allHref: "/categorias/vinos?buscar=malbec", allLabel: "Ver más Malbec" },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Las botellas sugeridas debajo salen del catálogo actual. Si una deja de estar disponible, no queda un enlace roto: la selección se actualiza. Si necesitás varias unidades o una presentación específica, hablá con Lombardo antes de confirmar.",
        ],
      },
    ],
    catalog: { mode: "category", categorySlug: "vinos", limit: 3, heading: "3 botellas para regalar con una razón", description: "Puntos de partida con precio y disponibilidad actuales. La elección final la completa la persona.", allHref: "/categorias/vinos", allLabel: "Ver vinos" },
...
const FOUNDATION_GUIDES: readonly GuideDefinition[] = [
  {
    ...
    sections: [
      ...
      { eyebrow: "02", title: "Compará lo disponible", paragraphs: ["Las listas estáticas envejecen rápido. Abrí cada producto para revisar marca, presentación, precio y estado antes de sumar al carrito. Si ya sabés qué buscás, el catálogo permite ir directo por nombre o marca."] },
    ...
    catalog: { mode: "category", categorySlug: "vinos", limit: 8, heading: "Vinos disponibles ahora", description: "Catálogo con precios actuales.", allHref: "/categorias/vinos", allLabel: "Ver vinos" },
    relatedSlugs: ["que-vino-llevar-a-una-cena", "vinos-por-menos-de-20000"],
    featured: false,
  },
  {
    ...
    catalog: { mode: "category", categorySlug: "vinos", limit: 8, heading: "Botellas para empezar a elegir", description: "Disponibilidad y precios consultados ahora.", allHref: "/categorias/vinos", allLabel: "Ver vinos" },
